 ...
 */
    ...
    #define BSP_PRV_PORT9_NE_PIN_MASK     (0x0F)    /* Missing pins: P90 P91 P92 P93 */
    ...
    #define BSP_PRV_PORTF_NE_PIN_MASK     (0x20)    /* Missing pins: PF5 */
    #define BSP_PRV_PORTH_NE_PIN_MASK     (0x00)    /* Missing pins: None */
    #define BSP_PRV_PORTJ_NE_PIN_MASK     (0x20)    /* Missing pins: PJ5 */
    #define BSP_PRV_PORTK_NE_PIN_MASK     (0x3C)    /* Missing pins: PK2 PK3 PK4 PK5 */
    #define BSP_PRV_PORTL_NE_PIN_MASK     (0x03)    /* Missing pins: PL0 PL1 */
    ...
    #define BSP_PRV_PORT0_NE_PIN_MASK     (0x87)    /* Missing pins: P00 P01 P02 P07 */
    ...
    #define BSP_PRV_PORTF_NE_PIN_MASK     (0x20)    /* Missing pins: PF5 */
    #define BSP_PRV_PORTH_NE_PIN_MASK     (0x00)    /* Missing pins: None */
    #define BSP_PRV_PORTJ_NE_PIN_MASK     (0x2A)    /* Missing pins: PJ1 PJ3 PJ5 */
    #define BSP_PRV_PORTK_NE_PIN_MASK     (0x3C)    /* Missing pins: PK2 PK3 PK4 PK5 */
    #define BSP_PRV_PORTL_NE_PIN_MASK     (0x03)    /* Missing pins: PL0 PL1 */
    ...
    #define BSP_PRV_PORT5_NE_PIN_MASK     (0x7F)    /* Missing pins: P50 P51 P52 P53 P54 P55 P56 */
    #define BSP_PRV_PORT6_NE_PIN_MASK     (0xFF)    /* Missing pins: P60 P61 P62 P63 P64 P65 P66 P67 */
    #define BSP_PRV_PORT7_NE_PIN_MASK     (0xFF)    /* Missing pins: P70 P71 P72 P73 P74 P75 P76 P77 */
    #define BSP_PRV_PORT8_NE_PIN_MASK     (0xCF)    /* Missing pins: P80 P81 P82 P83 P86 P87 */
    #define BSP_PRV_PORT9_NE_PIN_MASK     (0x0F)    /* Missing pins: P90 P91 P92 P93 */
